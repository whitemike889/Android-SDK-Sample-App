...
public class PayUOneClickPaymentActivity extends AppCompatActivity implements GetStoredCardApiListener, DeleteCardApiListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null == savedInstanceState && null != storedCardList && storedCardList.size() == 1 && (!payuUtils.getFromSharedPreferences(PayUOneClickPaymentActivity.this, storedCardList.get(0).getCardToken()).contains(PayuConstants.DEFAULT) || null != oneClickCardTokens.get(storedCardList.get(0).getCardToken()) )) { // yeay we can make payment
