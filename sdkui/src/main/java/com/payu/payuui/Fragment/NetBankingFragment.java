...
//        getActivity().findViewById(R.id.button_pay_now).setEnabled(true);
        ...
        if (netBankingList != null) {
            ...
            //try using base adapter

          //  Collections.sort(netBankingList);
...
//            List<String> spinnerArray = Arrays.asList(netBanksNamesArray);
            ...
            spinnerNetbanking.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int index, long l) {
                    ...
                    if(valueAddedHashMap.get(netBankingList.get(index).getBankCode()) != null && getActivity() != null) {
